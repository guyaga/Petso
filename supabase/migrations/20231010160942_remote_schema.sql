...
CREATE TABLE IF NOT EXISTS "public"."credits" (
    ...
    "credits" integer DEFAULT 0 NOT NULL, -- Set default value to 0
...
-- Ensuring that there is no existing trigger or function with the same name
...
-- Setting up the trigger function and a default credit value of 0 for all users
-- Create or update the trigger function
CREATE OR REPLACE FUNCTION public.handle_new_user()
RETURNS trigger AS $$
BEGIN
  -- Insert into the credits table with default credits value (0)
  INSERT INTO public.credits (user_id, credits)
  VALUES (NEW.id, 0); -- Set credits to 0
  RETURN NEW;
END;
