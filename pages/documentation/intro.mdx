...
Introducing **Framecast AI**, an intuitive SaaS platform powered by Astria that generates Professional AI
Headshots in minutes. This product is built to give developers & makers a great starting point into building AI
applications that can generate real revenue. This is your launch pad - modify it, and make it your own to build
a popular AI SaaS app.

<figure>
  <>![Framecast AI](../../assets/docs/7.png)</>
  <figcaption>The landing page of Framecast AI.</figcaption>
</figure>
...
To start using Framecast AI, you need to select an environment first:
...
<Cards num={2}>
  ...
  >
    <>![Local Environment](../../assets/ui/1.png)</>
  </Cards.Card>
  <Cards.Card
    image
    arrow
  ...
  >
    <>![Production Environment](../../assets/ui/1.png)</>
  </Cards.Card>
</Cards>

Currently using Framecast AI without using one of these built-in environments is not possible.

## Framecast AI FAQs

The Framecast AI FAQs is a collection of useful questions and answers about the project. If you have a question
...
<FAQBox title="Can I install Framecast AI on my cPanel or DirectAdmin type hosting server?">
  You're in luck! Our Framecast AI is designed for ultimate flexibility, so you
...
and `Resend`, you can deploy Framecast AI in minutes without the headaches of
...
<FAQBox title="Is Framecast AI entirely free to use?">
That's not quite the case! While Framecast AI offers incredible value, it's important to understand that creating 
...
purchasing Framecast AI. Is this true?"
>
  Let’s get real—do you expect to run a successful business without any ongoing costs? Framecast AI is your ticket
...
or are you looking for something that’s too good to be true? The truth is, with Framecast AI, you have everything
...
So, if you’re ready to turn your vision into reality, Framecast AI is for you. But if you’re afraid of a little
...
With Framecast AI, you’re getting top-tier services without the hefty price tag. If you want to build something
scalable and sustainable, this is the way to do it—affordably and effectively.

</FAQBox>

<FAQBox title="But I’m not a developer nor can I do sales. Can I still use Framecast AI and get a userbase?">
