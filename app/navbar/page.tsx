      ...
      {user ? (
        <>
          <div className="hidden md:flex space-x-4">
            ...
            {stripeIsConfigured && (
              <NavButton href="/get-credits" label="Get Credits" />
            )}
          </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuGroup className="md:hidden">
                  <NavDropdownItem href="/" label="Home" />
                  <NavDropdownItem href="/overview" label="Dashboard" />
                  {stripeIsConfigured && (
                    <NavDropdownItem href="/get-credits" label="Get Credits" />
                  )}
                </DropdownMenuGroup>
